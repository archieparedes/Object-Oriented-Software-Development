...
class AssertExp1 {
    ...
    /**
     *
     * @param list non-null array of double numbers
     * @return the minimum value of an array
     */
    public static double minValue(double[] list) {
        assert list != null; // precondition
        double min = list[0];
     ...
     * "==" informally):
     *
     * 0 == minPosition(new double[] { -7 }) 2 == AssertExp1.minPosition(new double[] { 1,
     ...
     *
     * @param list non-null array of double numbers
     * @return index of the smallest double number
     */
    public static int minPosition(double[] list) {
        ...
        assert list[index] == minValue(list); // postcondition
        return index;
    }
     ...
     *
     * @param list non-null array of double numbers
     * @return number of unique double numbers
     */
     ...
     *
     * @param list non-null array of double numbers
     * @return unique array of double numbers
     */
    public static double[] removeDuplicates(double[] list) {
        ...
        int iter = 0;
        double[] newList = new double[hm.size()];
        ...
        assert numUnique(list) == newList.length; // postcondition
        return newList;
